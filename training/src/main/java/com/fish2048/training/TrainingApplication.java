...
public class TrainingApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//MANEJOS
		Manejo mane1 = new Manejo(null, "Troca de água", "aberto a buera", sdf.parse("01/04/2018 13:40"));
		Manejo mane2 = new Manejo(null, "Manutenção em Alimentadores", "Periodico", sdf.parse("02/05/2018 13:40"));
		Manejo mane3 = new Manejo(null, "Troca de Sexo rsrs", "Sem palavras", sdf.parse("03/06/2018 13:40"));
		manejoRepository.saveAll(Arrays.asList(mane1, mane2, mane3));
